"""Custom scorers for skill:delta.table-introspect (auto-generated; bind to `evals/` suite)."""
...
@register_scorer(skill_id="skill:delta.table-introspect", name="ClaimCountAssertion")
...
@register_scorer(skill_id="skill:delta.table-introspect", name="ClaimShapeValidator")
...
@register_scorer(skill_id="skill:delta.table-introspect", name="Idempotence")
