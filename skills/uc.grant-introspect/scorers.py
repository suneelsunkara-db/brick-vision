"""Custom scorers for skill:uc.grant-introspect (auto-generated; bind to `evals/` suite)."""
...
@register_scorer(skill_id="skill:uc.grant-introspect", name="ClaimCountAssertion")
...
@register_scorer(skill_id="skill:uc.grant-introspect", name="ClaimShapeValidator")
...
@register_scorer(skill_id="skill:uc.grant-introspect", name="Idempotence")
