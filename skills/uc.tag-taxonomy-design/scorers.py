"""Custom scorers for skill:uc.tag-taxonomy-design (auto-generated; bind to `evals/` suite)."""
...
@register_scorer(skill_id="skill:uc.tag-taxonomy-design", name="Correctness")
...
@register_scorer(skill_id="skill:uc.tag-taxonomy-design", name="Guidelines:must-cite-evidence")
...
@register_scorer(skill_id="skill:uc.tag-taxonomy-design", name="RetrievalGroundedness")
...
@register_scorer(skill_id="skill:uc.tag-taxonomy-design", name="Safety")
